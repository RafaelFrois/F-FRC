...
const ScoreSchema = new mongoose.Schema({
  ...
  bonusAutoPoints: { type: Number, required: true, default: 0 },
  bonusTeleopPoints: { type: Number, required: true, default: 0 },
  bonusEndgamePoints: { type: Number, required: true, default: 0 },
